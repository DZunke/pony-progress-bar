...
import static dzunke.pony.PonyIcons.ICON;

public class PonyProgressBarUi extends BasicProgressBarUI {
    private static final float[] FRACTIONS = {0.5f, 1f};
    private static final Color PONY_COLOR_START = new JBColor(new Color(140, 99, 117), new Color(140, 99, 117));
    private static final Color PONY_COLOR_END = new JBColor(new Color(140, 99, 117, 255), new Color(140, 99, 117));
    private static final Color[] COLORS = {PONY_COLOR_START, PONY_COLOR_END};
    ...
    protected void paintIndeterminate(Graphics g, JComponent c) {
        ...
        Icon icon = velocity > 0 ? (PonyIcons.ICON) : (PonyIcons.ICON_REVERSED) ;
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        ICON.paintIcon(progressBar, g2d, amountFull - JBUI.scale(10), -JBUI.scale(1));
